...
namespace MyAlbumEditor
{
    public partial class EditorForm : Form
    {
        ...
        {
            cmbAlbums.DataSource = Directory.GetFiles(AlbumManager.DefaultPath,
   "*.abm");
        ...
        private void OpenAlbum(string path)
        {
            ...
            if (path != null && path.Length > 0 && AlbumController.CheckAlbumPassword(path,
ref password))
            {
                if (CloseAlbum())
                    return; // cancel open
        ...
        private void DisplayAlbum()
        {
            ...
            else
            {
                ...
                lstPhotos.FormatString
= Manager.Album.GetDescriptorFormat();
                if (Manager.Album.PhotoDescriptor
